...
## Demonstration
This demonstration creates a new Azure Storage Account Container, implements Azure Storage Account Container Protection on that bucket, and then deploys an instance with several test scripts and sample files for testing the integration in a real environment.
